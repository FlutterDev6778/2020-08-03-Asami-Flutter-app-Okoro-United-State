...
class PrivacyPageStyles {
  ...
  PrivacyPageStyles(BuildContext context) {}
}

class PrivacyPageMobileStyles extends PrivacyPageStyles {
  PrivacyPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
