...
class _MemberDetailPageState extends State<MemberDetailPage> {
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          ...
                          onTap: () {
                            _deleteFeed(context, _feedModel);
                          },
                        )
                      ],
                    )
  ...
  void _deleteFeed(BuildContext context, FeedModel feedModel) async {
    await KeicyProgressDialog.of(context).show();
    await KeicyStorageForMobile.instance.deleteFile(path: feedModel.imageUrl);
    await FeedDataProvider.deleteFeed(id: feedModel.id);
