...
class HerbPageStyles {
  ...
  HerbPageStyles(BuildContext context) {}
}

class HerbPageMobileStyles extends HerbPageStyles {
  HerbPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
