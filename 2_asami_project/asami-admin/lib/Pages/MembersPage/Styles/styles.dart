...
class MembersPageStyles {
  ...
  MembersPageStyles(BuildContext context) {}
}

class MembersPageMobileStyles extends MembersPageStyles {
  MembersPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
