...
class PromoCodesPageStyles {
  ...
  PromoCodesPageStyles(BuildContext context) {}
}

class PromoCodesPageMobileStyles extends PromoCodesPageStyles {
  PromoCodesPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
